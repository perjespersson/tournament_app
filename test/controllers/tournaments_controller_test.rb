...
class TournamentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create tournament" do
    assert_difference('Tournament.count') do
      post tournaments_url, params: { tournament: { name: @tournament.name, pin: @tournament.pin } }
    end
  ...
  test "should update tournament" do
    patch tournament_url(@tournament), params: { tournament: { name: @tournament.name, pin: @tournament.pin } }
